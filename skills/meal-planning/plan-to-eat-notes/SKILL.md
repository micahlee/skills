...
Do **not** flag: events starting before 4:00pm (e.g., morning cell group, afternoon trumpet lessons).

**Note text format:** just the event name (trimmed). No start time, no editorializing.

Examples:
- `Coleman Skating`
- `Trappe Door Reservation`
- `Walt Disney World`
...
```
May 1   Walt Disney World
May 2   Walt Disney World
May 4   Coleman Skating 5:30pm
