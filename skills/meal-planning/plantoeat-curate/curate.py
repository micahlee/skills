#!/usr/bin/env python3
"""plantoeat-curate — propose tag/metadata updates in named batches.

Pipeline:
  1. Load state (~/.plantoeat/curate/state.json); get live recipe IDs.
...
STATE_DIR = os.path.expanduser("~/.plantoeat/curate")
STATE_PATH = os.path.join(STATE_DIR, "state.json")
PLANTOEAT_BIN = os.environ.get("PLANTOEAT_BIN", "plantoeat")
THROTTLE_S = 0.2
FETCH_RETRIES = 3
