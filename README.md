...
- `plantoeat-curate`: Propose tag and metadata updates for Plan to Eat recipes.
- `plantoeat-suggestions`: Maintain a ranked "next meals to make" Google Doc from Plan to Eat history.
